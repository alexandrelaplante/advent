...
data = """.....487.599...........411...........................................574..679.136..........................30......255.......432............
....*......*............*..........&586..........................375...@..*....../.....835.............610*........./...............582.....
...
......696..................................................753......................957.715.............396..159...........338.......806....""".split(
    "\n"
)
...
class Number:
    ...
    @property
    def adjacency_rectangle(self) -> Rectangle:
        return Rectangle(
            start_x=self.x - 1,
            start_y=self.y - 1,
            end_x=self.x + (self.width - 1) + 1,
            end_y=self.y + 1,
        )
...
def collect_numbers(data: list[str]) -> Iterator[Number]:
    for y, line in enumerate(data):
        start = None
        for x, d in enumerate(line + "."):
            if d.isdigit() and start is None:
                start = x
            if not d.isdigit() and start is not None:
                yield Number(x=start, y=y, num=int(line[start:x]))
                start = None


def get(data: list[str], x: int, y: int) -> Optional[str]:
    try:
        return data[y][x]
    except IndexError:
        return "."
...
def is_symbol_adjacent(data: list[str], number: Number) -> bool:
    rect = number.adjacency_rectangle
    for x in range(rect.start_x, rect.end_x + 1):
        for y in range(rect.start_y, rect.end_y + 1):
            if get(data, x, y) not in list(".1234567890"):
                return True
    return False


def get_adjacent_gears(data: list[str], number: Number) -> Iterator[Gear]:
    rect = number.adjacency_rectangle
    for x in range(rect.start_x, rect.end_x + 1):
        for y in range(rect.start_y, rect.end_y + 1):
            if get(data, x, y) == "*":
...
def part1(data):
    numbers = list(collect_numbers(data))
    total = 0
    for number in numbers:
        if is_symbol_adjacent(data, number):
            total += number.num
    return total
...
def part2(data):
    ...
    for number in numbers:
        for gear in get_adjacent_gears(data, number):
            gears[(gear.x, gear.y)].append(number.num)
